...
const skip = require('../skip_test.json')['lib/routine'];
let seneca;
...
const check_strategy_config = function (err, val) {
...
const check_evaluator_config = function (err, val) {
...
function intialize(done) {
  intialize_server.get_server(function (options) {
    ...
    const entity_2_1 = seneca.make$('strategy_stock', {
      strategy_id: 'fifty_2_wk',
    ...
    const entity_2_1_save$ = Promise.promisify(entity_2_1.save$, {
      context: entity_2_1,
    });
    const entity_2_2 = seneca.make$('strategy_stock', {
      strategy_id: 'fifty_2_wk',
    ...
    const entity_2_2_save$ = Promise.promisify(entity_2_2.save$, {
      context: entity_2_2,
    });
    const entity_3_1 = seneca.make$('watchlist', {
      strategy_id: 'fifty_2_wk',
      tradingsymbol: 'YESBANK',
      status: 'ACTIVE',
      update_time: null,
    });
    const entity_3_1_save$ = Promise.promisify(entity_3_1.save$, {
      context: entity_3_1,
    });
    const entity_3_2 = seneca.make$('watchlist', {
      strategy_id: 'fifty_2_wk',
      tradingsymbol: 'STOREONE',
      status: 'ACTIVE',
      update_time: null,
    });
    const entity_3_2_save$ = Promise.promisify(entity_3_2.save$, {
      context: entity_3_2,
    });
